...
KERNEL_VERSION="$(< kernel-version.txt)"
install -m 644 -D ./asustor-platform-driver/asustor.ko \
  "/lib/modules/${KERNEL_VERSION}/kernel/drivers/platform/x86/asustor.ko"
install -m 644 -D ./asustor-platform-driver/asustor_it87.ko \
  "/lib/modules/${KERNEL_VERSION}/kernel/drivers/hwmon/asustor_it87.ko"
install -m 644 -D ./asustor-platform-driver/asustor_gpio_it87.ko \
